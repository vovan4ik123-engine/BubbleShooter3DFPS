...
namespace BubbleShooter3D
{
    PlayStateGUILayer::PlayStateGUILayer()
    {
        ...
        slider1 = std::make_shared<Beryll::SliderHorizontal>("1", EnumsAndVars::FontsPath::roboto, 0.04f, 0.005f, 0.11f, 0.2f, 0.04f, 1.0f, 5.0f);
        m_guiObjects.push_back(slider1);
        slider1->setValue(3.0f);

        slider2 = std::make_shared<Beryll::SliderHorizontal>("2", EnumsAndVars::FontsPath::roboto, 0.04f, 0.005f, 0.16f, 0.2f, 0.04f, 1.0f, 5.0f);
        m_guiObjects.push_back(slider2);
        slider2->setValue(3.0f);

        slider3 = std::make_shared<Beryll::SliderHorizontal>("3", EnumsAndVars::FontsPath::roboto, 0.04f, 0.005f, 0.21f, 0.2f, 0.04f, 1.0f, 5.0f);
        m_guiObjects.push_back(slider3);
        slider3->setValue(3.0f);
    }
